...
@RestController // JsonやXML等を返すWebAPI用のコントローラで使用する。アノテーションと言われるやつ
public class TestController {
  @RequestMapping(path = "/test", method = RequestMethod.GET) // @RequestMapping:Spring MVC のコントローラに付与して、リクエスト URL に対して、どのメソッドが処理を実行するか定義するアノテーション
  public String test() {
    return "ok from test.";
  }
